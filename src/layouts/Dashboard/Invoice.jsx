                        ...
                        <table className="table table-borderless mb-0">
                            ...
                            <tr className="border-bottom">
                                <td>
                                    ...
                                    <div className="small text-muted d-none d-md-block">A professional UI toolkit for
                            ...
                            <tr className="border-bottom">
                                <td>
                                    ...
                                    <div className="small text-muted d-none d-md-block">A UI toolkit for creating
                            ...
                            <tr className="border-bottom">
                                <td>
                                    ...
                                    <div className="small text-muted d-none d-md-block">A fully coded set of UI
                            ...
                            <tr>
                                <td className="text-right pb-0" colSpan="3">
                                    <div className="text-uppercase small font-weight-bold text-muted">Total Amount Due:
                                    </div>
                                </td>
                                <td className="text-right pb-0">
